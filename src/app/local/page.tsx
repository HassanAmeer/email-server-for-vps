    ...
    <div className="local-console-theme bg-[#0B0F19] text-gray-100 min-h-screen relative overflow-x-hidden font-sans">
      ...
      <main className="max-w-[1300px] w-full mx-auto p-8 relative z-10 flex flex-col gap-6 min-h-screen">
        ...
        <div className="relative bg-white/[0.04] border border-white/[0.08] backdrop-blur-2xl rounded-[1.75rem] p-4 sm:p-6 shadow-[0_8px_40px_rgba(0,0,0,0.35)] overflow-hidden">
          ...
          <div className="pointer-events-none absolute -top-24 -right-20 w-72 h-72 bg-purple-500/[0.12] rounded-full blur-[90px]" />
          <div className="pointer-events-none absolute -bottom-28 -left-20 w-72 h-72 bg-fuchsia-500/[0.08] rounded-full blur-[90px]" />

          {/* Section Header */}
          <div className="relative flex items-center justify-between gap-3 mb-4">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-purple-400/30 to-fuchsia-400/10 border border-white/15 flex items-center justify-center shadow-lg shadow-purple-500/10">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" className="w-5 h-5 text-purple-300">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
              </div>
              <div className="min-w-0">
                <h2 className="text-white font-semibold text-base sm:text-lg tracking-tight leading-tight truncate">Create Local Mailbox</h2>
            ...
            {selectedDomain && (
              <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/[0.08] border border-white/10 text-purple-300 text-[11px] font-semibold shrink-0">
          ...
          <div className="relative flex flex-col md:flex-row items-stretch md:items-center gap-2.5 w-full">
            ...
            <div className="flex flex-col gap-1.5 shrink-0">
              ...
              <button
                ...
                className="h-11 px-4 flex items-center justify-center gap-2 rounded-xl bg-white/[0.06] border border-white/10 hover:bg-white/[0.1] text-purple-300 transition-all cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed active:scale-[0.97]"
            ...
            <div className="flex flex-col gap-1.5 flex-1 min-w-[240px]">
              ...
              <div className="flex items-stretch bg-white/[0.05] border border-white/10 rounded-xl focus-within:border-purple-400/50 focus-within:bg-white/[0.07] transition-all overflow-hidden">
                <div className="flex items-center px-3 bg-white/[0.04] border-r border-white/[0.07]">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" className="w-4 h-4 text-purple-300/70 shrink-0">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                  </svg>
                </div>
                <input
                ...
                <div className="flex items-center flex-1 min-w-0 bg-white/[0.04]">
                  <span className="text-purple-300 font-mono select-none px-1.5 shrink-0">@</span>
                  <select
            ...
            <button
              ...
              className="h-11 px-6 bg-purple-400 hover:bg-purple-300 active:scale-[0.97] text-slate-950 font-semibold rounded-xl text-sm transition-all shadow-[0_6px_24px_rgba(192,132,252,0.35)] hover:shadow-[0_6px_32px_rgba(192,132,252,0.5)] flex items-center justify-center gap-2 shrink-0 cursor-pointer whitespace-nowrap disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none"
          ...
          <div className="relative mt-4">
            {generatedEmail ? (
              <div className="relative bg-white/[0.03] border border-white/10 rounded-xl px-4 py-3 flex items-center justify-between gap-3 overflow-hidden">
                <div className="pointer-events-none absolute inset-y-0 left-0 w-[3px] bg-purple-400" />
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-[9px] uppercase text-purple-300/80 font-semibold tracking-widest">Active Mailbox</span>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  <button 
                    ...
                    className="bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 p-2 rounded-lg transition-all text-gray-300 hover:text-purple-300 cursor-pointer active:scale-95"
                    title="Copy Email"
                  >
                    {copiedGen ? (
                  ...
                  <button
                    ...
                    className="bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 p-2 rounded-lg transition-all text-gray-300 hover:text-purple-300 cursor-pointer active:scale-95 disabled:opacity-40"
                    title="Regenerate"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={`w-3.5 h-3.5 ${isGenerating ? "animate-spin text-purple-400" : ""}`}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3" />
                    </svg>
                  </button>
                </div>
              ...
              <div className="bg-white/[0.03] border border-dashed border-white/[0.12] px-4 py-3 rounded-xl flex items-center justify-center">
                <span className="text-gray-400/80 text-[11px] sm:text-xs text-center tracking-tight">Click <span className="text-purple-300 font-semibold">Random</span> to generate a name or type a custom one, then <span className="text-purple-300 font-semibold">Save</span> to start receiving mail</span>
              </div>
            )}
          </div>
        </div>
        ...
        <nav className="flex gap-3 bg-white/[0.02] p-1.5 rounded-xl border border-white/[0.06] w-fit overflow-x-auto no-scrollbar max-w-full">
          <button
            ...
            className={`tab-btn flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all whitespace-nowrap ${activeTab === "inbox-tab" ? "text-white bg-white/[0.05]" : "text-gray-400 hover:text-white"
              }`}
          >
          ...
          <button
            ...
            className={`tab-btn flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all whitespace-nowrap ${activeTab === "json-tab" ? "text-white bg-white/[0.05]" : "text-gray-400 hover:text-white"
              }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4.5 h-4.5">
          ...
          <button
            ...
            className={`tab-btn flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all whitespace-nowrap ${activeTab === "syslog-tab" ? "text-white bg-white/[0.05]" : "text-gray-400 hover:text-white"
              }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4.5 h-4.5">
          ...
          <button
            ...
            className={`tab-btn flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all whitespace-nowrap ${activeTab === "sending-tab" ? "text-white bg-white/[0.05]" : "text-gray-400 hover:text-white"
              }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4.5 h-4.5">
          ...
          <button
            ...
            className={`tab-btn flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold cursor-pointer transition-all whitespace-nowrap ${activeTab === "send-tab" ? "text-white bg-white/[0.05]" : "text-gray-400 hover:text-white"
              }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4.5 h-4.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
